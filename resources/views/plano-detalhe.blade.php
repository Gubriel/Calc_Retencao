                ...
                <div class="p-4 bg-white rounded shadow">
                    ...
                    <div class="mb-4 space-y-2">
                        <div>
                            ...
                            <input type="text" nome="cliente_nome" value="{{ $base }} Meses" class="w-full px-2 py-2 text-center rounded bg-gray-200" disabled>
                        </div>
                        @if ($qntd_visitas > 0)
                        <div>
                            <label class="block text-red-900 font-semibold">Qntd. devisitas técnicas</label>
                        ...
                        <div>
                            ...
                            <input type="text" nome="cliente_nome" value="{{ $qntd_atrasos }} Meses" class="w-full px-2 py-2 text-center rounded bg-gray-200" disabled>
                        </div>
                        @endif
                        <div>
                            <label class="block text-red-900 font-semibold">Receita media</label>
                            <input type="text" nome="cliente_nome" value="R${{ $media }}" class="w-full px-2 py-2 text-center rounded bg-gray-200" disabled>
                        </div>
                        @if($retencao == 'Não')
                            <div>
                        ...
                        @else
                            ...
                            @if ($mensalidades > 0)
                                <div>
                                    <label class="block text-red-900 font-semibold">Mensalidades</label>
                                    <input type="text" nome="cliente_nome" value="{{ $mensalidades }} Meses" class="w-full px-2 py-2 text-center rounded bg-gray-200" disabled>
                                </div>
                            @endif
                            @if ($movel_gratis > 0)
                                <div>
                                    <label class="block text-red-900 font-semibold">Plano Movel Grátis</label>
                                    <input type="text" nome="cliente_nome" value="{{ $movel_gratis }} Meses" class="w-full px-2 py-2 text-center rounded bg-gray-200" disabled>
                                </div>
                            @endif
                            @if ($sva_gratis > 0)
                                <div>
                                    <label class="block text-red-900 font-semibold">SVAs Grátis</label>
                                    <input type="text" nome="cliente_nome" value="{{ $sva_gratis }} Meses" class="w-full px-2 py-2 text-center rounded bg-gray-200" disabled>
                                </div>
                            @endif
                        @endif
                    </div>
