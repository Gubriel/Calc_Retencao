...
<head>
    ...
    <body class="bg-light">
        <div class="container w-full py-5">
            ...
            <div class="mt-5 flex-column itens-center rounded-top border-4 border-bottom-0 border-top-0 border-gray-700 shadow">
                <div class="text-center itens-center justify-center flex text-xl text-black">
                    <div class="p-2 col-md-12 bg-gray-700 justify-content-between">
                ...
                <div class="text-left justify-center flex p-3 text-xl">
                    ...
                    <div class="row p-1 flex-col col-3">
                        ...
                        <div>Data de cadastro: 90/12/1984</div>
                    </div>
                    <div class="row p-1 flex-col col-3">
            ...
            @else
                <div class="p-1 bg-gray-700 shadow rounded-bottom">
                    ...
                    <div class="p-2 bg-success rounded-bottom-1">
